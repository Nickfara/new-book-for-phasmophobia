...
loadSound('http://localhost:8000/assets/footstep.mp3',0)
loadSound('http://localhost:8000/assets/footstep_asphalt_2.mp3',1)
loadSound('http://localhost:8000/assets/footstep_asphalt_3.mp3',1)
loadSound('http://localhost:8000/assets/footstep_carpet_2.mp3',2)
loadSound('http://localhost:8000/assets/footstep_carpet_3.mp3',2)
loadSound('http://localhost:8000/assets/footstep_gravel.mp3',3)
loadSound('http://localhost:8000/assets/footstep_gravel_2.mp3',3)
loadSound('http://localhost:8000/assets/footstep_wood_2.mp3',4)
loadSound('http://localhost:8000/assets/footstep_wood_3.mp3',4)
loadSound('http://localhost:8000/assets/footstep_metal_stairs.mp3',5)
loadSound('http://localhost:8000/assets/footstep_metal_stairs_2.mp3',5)
loadSound('http://localhost:8000/assets/footstep_metal_stairs_3.mp3',5)
loadSound('http://localhost:8000/assets/footstep_squishy.mp3',6)
loadSound('http://localhost:8000/assets/footstep_squishy_2.mp3',6)
loadSound('http://localhost:8000/assets/footstep_squishy_3.mp3',6)
loadSound('http://localhost:8000/assets/footstep_krampus.mp3',7)
loadSound('http://localhost:8000/assets/footstep_krampus_2.mp3',7)
loadSound('http://localhost:8000/assets/footstep_krampus_3.mp3',7)
loadSound('http://localhost:8000/assets/footstep_forest_spirit.mp3',8)
loadSound('http://localhost:8000/assets/footstep_forest_spirit_2.mp3',8)
