...
function changeTheme(name = null){
    ...
    if(themes[theme_name] == "theme-blood-moon-particle"){
        ...
        document.body.style.backgroundImage = "radial-gradient(circle, rgba(0,0,0,0.7), rgba(0,0,0,0.8)), url('https://nickfara.github.io/new-book-for-phasmophobia/phasmophobia/static/imgs/bm-background.jpg')"
    }
    else if(themes[theme_name] == "theme-snow-particle"){
        if(!document.getElementById("disable_particles").checked){
            snowInterval = setInterval(createSnowParticle, 200);
        }
        document.body.style.backgroundImage = "radial-gradient(circle, rgba(0,0,0,0.75), rgba(0,0,0,1)), url('https://nickfara.github.io/new-book-for-phasmophobia/phasmophobia/static/imgs/background.jpg')"
    }
        ...
        document.body.style.backgroundImage = "radial-gradient(circle, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.6)), url('https://nickfara.github.io/new-book-for-phasmophobia/phasmophobia/static/imgs/background-cozy.png')"
    }
    else{
        document.body.style.backgroundImage = "radial-gradient(circle, rgba(0,0,0,0.75), rgba(0,0,0,1)), url('https://nickfara.github.io/new-book-for-phasmophobia/phasmophobia/static/imgs/background.jpg')"
    }
