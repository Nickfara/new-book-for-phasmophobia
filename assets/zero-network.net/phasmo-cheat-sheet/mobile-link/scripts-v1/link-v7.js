...
function load_ghost_data(){
    fetch("http://localhost:8000/phasmophobia/data/ghosts.json", {cache: 'default', signal: AbortSignal.timeout(10000)})
    .then(data => data.json())
    .then(data => {
...
function startlink(link_id=null){
    ...
    fetch(`http://localhost:8000/znlink/create-link/znml`,{method:"POST",Accept:"application/json",signal: AbortSignal.timeout(6000)})
