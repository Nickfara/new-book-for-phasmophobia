...
function getMaps(){
    let loadMaps = new Promise((resolve, reject) => {
        fetch("http://localhost:8000/phasmophobia/data/maps", {signal: AbortSignal.timeout(6000)})
        .then(data => data.json())
        .then(data => {
            var map_html = ""
    ...
    let loadSpots = new Promise((resolve, reject) => {
        fetch("http://localhost:8000/phasmophobia/data/map-hiding-spots", {signal: AbortSignal.timeout(6000)})
        .then(data => data.json())
        .then(data => {
